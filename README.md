...
$env:PHOENIX_VIDEO_PROVIDER="openai"
$env:PHOENIX_VIDEO_MODEL="sora-2"
$env:PHOENIX_VIDEO_SIZE="720x1280"
$env:PHOENIX_VIDEO_DURATION_SECONDS="8"
docker compose up --build
```
...
OPENAI_API_KEY=
PHOENIX_VIDEO_MODEL=sora-2
PHOENIX_VIDEO_SIZE=720x1280
