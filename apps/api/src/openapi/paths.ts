...
export const paths = {
  ...
  "/knowledge/entities": { get: { ...secured, tags: ["Knowledge"], summary: "List knowledge graph entities", responses: { "200": ok("Knowledge entities"), ...errors } } },
  "/knowledge/relations": { get: { ...secured, tags: ["Knowledge"], summary: "List knowledge graph relations", responses: { "200": ok("Knowledge relations"), ...errors } } },
